<template>
   <div class="box-dices">
       <div class="dice" id="dice-1">
            <div v-bind:class= "spinnerClass1">
        ...
        <div class="dice" id="dice-2">
            <div v-bind:class= "spinnerClass2">
                <div class="face1">1</div>
                <div class="face2">2</div>
                <div class="face3">3</div>
                <div class="face4">4</div>
...
export default {
    ...
    computed:{
       spinnerClass1: function(){
           return "spinner dice-" + this.dices[0]
        }, 

       spinnerClass2: function(){
           
           return "spinner dice-" + this.dices[1]
        }
    }
